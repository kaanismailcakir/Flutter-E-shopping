          ...
          itemCount: 1,
            itemBuilder: (context,index) {
              return Card(
                child: Column(
                  children: [
                    Image.asset("assets/images/ebise.jpg"),
                    ListTile(
                      title:Text("Elbise"),
                      subtitle: Text("Fiyat:₺89.99"),
                    ),
                     Image.asset("assets/images/forma.jpg"),
                    ListTile(
                      title:Text("Turkiye Spor Formasıs"),
                      subtitle: Text("Fiyat:₺125.99"),
                    ),
                     Image.network(""),
                    ListTile(
                      title:Text(""),
